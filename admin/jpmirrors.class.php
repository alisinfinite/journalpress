...
<table class="form-table"><tbody>
  <tr>
    ...
    <td><input name="new[server]" type="text" id="jp_server" value="www.livejournal.com" class="regular-text">
        <p class="description">e.g. <kbd>www.livejournal.com</kbd>, <kbd>www.dreamwidth.org</kbd>, etc.</p></td>
  </tr>
  <tr>
